...
ExceptedSuits = {["respawndivingsuit"] = {valid = true,index = 0},["exosuit"] = {valid = true, index =1},["clownexosuit"] = {valid = true, index = 1}, --Vanilla Ice Cream
...
IndexedSuits = {["pucs"] = 2} -- Used for suits that have extra storage. I.E pucs.
